 ...
 *
 * @method $this distinct($field)
 * @method $this alias($alias)
 * @method $this order($order)
 * @method $this group($group)
 * @method $this having($group)
 * @method int count($field = null)
 * @method string sum($field = null)
 * @method string min($field = null)
 * @method string max($field = null)
 * @method string avg($field = null)
 */
class Model {
    // 操作状态
